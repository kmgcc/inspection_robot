        ...
        try:
            return compute_heading_hold_correction(
                ...
                HeadingHoldSettings(
                    ...
                    tolerance_degrees=_env_float("HEADING_HOLD_TOLERANCE_DEG", 0.25),
                    ...
                    correction_speed=_env_optional_int("HEADING_HOLD_CORRECTION_SPEED") or 35,
                    ...
                    speed_gain=_env_float("HEADING_HOLD_SPEED_GAIN", 5.0),
                    min_correction_speed=_env_float("HEADING_HOLD_MIN_CORRECTION_SPEED", 6),
                ),
