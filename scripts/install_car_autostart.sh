...
Environment=ROBOT_SLOW_SPEED=18
Environment=ROBOT_PATROL_SPEED=18
Environment=SMOOTH_CRUISE_ENABLED=1
Environment=CRUISE_SPEED=18
...
Environment=LINE_FOLLOW_SPEED=20
Environment=HEADING_HOLD_CORRECTION_SPEED=16
Environment=HEADING_HOLD_SPEED_GAIN=2.4
