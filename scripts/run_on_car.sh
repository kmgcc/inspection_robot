...
RUN_MODE='$RUN_MODE' LINE_FOLLOW_ENABLED='$LINE_FOLLOW_ENABLED' SMOOTH_CRUISE_ENABLED='$SMOOTH_CRUISE_ENABLED' CRUISE_SPEED='$CRUISE_SPEED' BOUNDARY_MIN_BLACK_SENSORS='$BOUNDARY_MIN_BLACK_SENSORS' BOUNDARY_CONFIRM_SAMPLES='$BOUNDARY_CONFIRM_SAMPLES' BOUNDARY_CONFIRM_GAP_SECONDS='$BOUNDARY_CONFIRM_GAP_SECONDS' HEADING_HOLD_CORRECTION_SPEED='$HEADING_HOLD_CORRECTION_SPEED' HEADING_HOLD_SPEED_GAIN='$HEADING_HOLD_SPEED_GAIN' HEADING_HOLD_MIN_INTERVAL_SECONDS='$HEADING_HOLD_MIN_INTERVAL_SECONDS' OBJECT_PRESENCE_COOLDOWN_SECONDS='$OBJECT_PRESENCE_COOLDOWN_SECONDS' PORT='$PORT' FLAGS_use_mkldnn=0 OMP_NUM_THREADS=1 CPU_NUM=1 nohup \"\$PYTHON_CMD\" app.py > app.log 2>&1 & echo \$!
"
