...
"
echo "Started on $CAR_HOST:$CAR_DIR with RUN_MODE=$RUN_MODE, LINE_FOLLOW_ENABLED=$LINE_FOLLOW_ENABLED, SMOOTH_CRUISE_ENABLED=$SMOOTH_CRUISE_ENABLED, CRUISE_SPEED=$CRUISE_SPEED, BOUNDARY_MIN_BLACK_SENSORS=$BOUNDARY_MIN_BLACK_SENSORS, BOUNDARY_CONFIRM_SAMPLES=$BOUNDARY_CONFIRM_SAMPLES, ROBOT_PIPER_MODEL=$ROBOT_PIPER_MODEL, PORT=$PORT"
